        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="needs-validation" action="{{ route('tasks.update', $tasks->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                            <div class="col">
                                                <div class="form-group col-md-12">
                                                    <label>Judul</label>
                                                    <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul', $tasks->judul) }}" required>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ old('deskripsi', $tasks->deskripsi) }}" required>{{ $tasks->deskripsi }}</textarea>
