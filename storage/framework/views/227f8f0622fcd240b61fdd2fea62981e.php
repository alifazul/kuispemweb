        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="needs-validation" action="<?php echo e(route('tasks.changestatus', [$tasks->id,$tasks->status])); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="judul" value="<?php echo e(old('judul', $tasks->judul)); ?>" disabled required>
...
unset($__errorArgs, $__bag); ?>" name="deskripsi" value="<?php echo e(old('deskripsi', $tasks->deskripsi)); ?>" required disabled><?php echo e($tasks->deskripsi); ?></textarea>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kuis_pemweb\resources\views/edit_status.blade.php ENDPATH**/ ?>